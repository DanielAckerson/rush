...
fn test_lexer() {
    use Token::*;
    assert_eq!(
        lexer("echo \"This is a \'test\'. I repeat, a \\\"TEST\\\"\" \'See?\' Check\\ it\\ out!"),
        Some(vec![
            ...
            Whitespace(" ".to_owned()),
            Text("Check".to_owned()),
            Escape("\\".to_owned()), Whitespace(" ".to_owned()),
            Text("it".to_owned()),
            Escape("\\".to_owned()), Whitespace(" ".to_owned()),
            Text("out!".to_owned()),
    ]));
...
fn test_parser() {
    use Token::*;
    assert_eq!(
        parse("echo \"This is a \'test\'. I repeat, a \\\"TEST\\\"\" \'See?\' Check\\ it\\ out!"),
        Ok(vec![
            Path("echo".to_owned()),
            Arg("This is a \'test\'. I repeat, a \"TEST\"".to_owned()),
            Arg("See?".to_owned()),
            Arg("Check it out!".to_owned()),
    ]));
}
